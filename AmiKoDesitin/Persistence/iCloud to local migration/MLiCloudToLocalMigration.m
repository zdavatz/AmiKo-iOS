...
- (void)tryToMigrate {
    ...
    [manager doctorDictionary]; // Migrate to file based doctor storage
...
- (void)moveFile:(NSURL *)url toURL:(NSURL *)targetUrl overwriteIfExisting:(BOOL)overwrite {
    ...
    [MLUtility moveFile:url toURL:targetUrl overwriteIfExisting:overwrite];
}
...
- (void)copyFile:(NSURL *)url toURL:(NSURL *)targetUrl overwriteIfExisting:(BOOL)overwrite {
    ...
    [MLUtility copyFile:url toURL:targetUrl overwriteIfExisting:overwrite];
}
